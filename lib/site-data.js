...
const english = {
  ...
  footer: {
    ...
    supportLinks: [
      ...
      { label: "Student Portal", href: "/{locale}/portal" },
  ...
  shared: {
    ...
    portalTitle: "Student Portal Access",
    portalIntro: "Manage your courses, schedules, learning resources, and progress in one clean dashboard experience.",
    portalDescription:
      "The Engel student portal keeps everything in one place: class calendars, payment history, homework updates, certificates, and direct communication with your academic team.",
    portalPrimaryCta: "Request Portal Access",
    privacyTitle: "Privacy Policy",
    privacyIntro: "We handle student, applicant, and contact data with clear boundaries and practical safeguards.",
    privacySections: [
      {
        title: "What we collect",
        body: "We collect information you submit in forms, such as your name, email address, phone number, preferred course, and any details relevant to placement or enrollment.",
      },
      {
        title: "Why we use it",
        body: "We use your data to respond to inquiries, recommend the right level, manage student communication, and improve the quality of academy services.",
      },
      {
        title: "How we protect it",
        body: "Access is limited to authorized staff, and operational data is handled only for clear academic or support purposes with retention kept proportionate.",
      },
    ],
    termsTitle: "Terms of Service",
    termsIntro: "These terms define how learners use academy services, bookings, and digital resources responsibly.",
    termsSections: [
      {
        title: "Bookings and enrollment",
        body: "Course placement, enrollment, and scheduling are confirmed after review of your request and availability. Specific class placement may change based on level and capacity.",
      },
      {
        title: "Student responsibilities",
        body: "Students are expected to attend on time, communicate schedule conflicts early, and use portal resources and class materials respectfully.",
      },
      {
        title: "Academy commitments",
        body: "The academy provides clear scheduling information, qualified teaching staff, and timely communication about course changes, levels, and support processes.",
      },
    ],
  },
};
...
const german = {
  ...
  footer: {
    ...
    links: [
      ...
      { label: "Lehrkraefte", href: "/{locale}/teachers" },
      { label: "Blog und Tipps", href: "/{locale}/blog" },
    ],
    supportLinks: [
      { label: "Einstufungstest", href: "/{locale}/placement-test" },
      { label: "FAQ", href: "/{locale}/faq" },
      { label: "Studentenportal", href: "/{locale}/portal" },
      { label: "Kontakt", href: "/{locale}/contact" },
    ],
    legalLinks: [
      { label: "Datenschutz", href: "/{locale}/privacy" },
      { label: "AGB", href: "/{locale}/terms" },
    ],
    location: "Wien, Oesterreich",
  ...
  shared: {
    ...
    portalTitle: "Zugang zum Studentenportal",
    portalIntro: "Verwalte Kurse, Stundenplaene, Lernmaterialien und deinen Fortschritt in einer klaren zentralen Ansicht.",
    portalDescription:
      "Im Engel-Portal findest du Kalender, Zahlungen, Hausaufgaben, Zertifikate und die direkte Kommunikation mit dem Akademie-Team an einem Ort.",
    portalPrimaryCta: "Portalzugang anfragen",
    privacyTitle: "Datenschutz",
    privacyIntro: "Wir behandeln Daten von Interessierten und Studierenden mit klaren Regeln und angemessenen Schutzmassnahmen.",
    privacySections: [
      {
        title: "Welche Daten wir erfassen",
        body: "Wir erfassen Angaben aus Formularen wie Name, E-Mail-Adresse, Telefonnummer, gewuenschter Kurs und Informationen zur Einstufung oder Anmeldung.",
      },
      {
        title: "Wofuer wir sie nutzen",
        body: "Wir nutzen diese Daten, um Anfragen zu beantworten, das passende Niveau zu empfehlen, die Kommunikation mit Lernenden zu organisieren und unsere Leistungen zu verbessern.",
      },
      {
        title: "Wie wir sie schuetzen",
        body: "Der Zugriff ist auf berechtigte Mitarbeitende beschraenkt. Operative Daten werden nur fuer klare akademische und organisatorische Zwecke verwendet.",
      },
    ],
    termsTitle: "AGB",
    termsIntro: "Diese Bedingungen regeln die Nutzung der Akademie-Angebote, Buchungen und digitalen Ressourcen.",
    termsSections: [
      {
        title: "Buchung und Anmeldung",
        body: "Kursplatzierung, Anmeldung und Zeitplanung werden nach Pruefung deiner Anfrage und Verfuegbarkeit bestaetigt. Die konkrete Zuordnung kann sich je nach Niveau und Kapazitaet aendern.",
      },
      {
        title: "Pflichten der Lernenden",
        body: "Lernende nehmen puenktlich teil, melden Terminprobleme fruehzeitig und nutzen Portal und Unterrichtsmaterialien verantwortungsvoll.",
      },
      {
        title: "Verpflichtungen der Akademie",
        body: "Die Akademie stellt klare Termininformationen, qualifizierte Lehrkraefte und zeitnahe Kommunikation zu Kursaenderungen, Niveaus und Support bereit.",
      },
    ],
  },
};
