  ...
  return (
    <SiteShell locale={locale} content={content}>
      <section className="mx-auto max-w-5xl px-6 py-16">
        ...
        <h1 className="mt-4 text-4xl font-bold text-brand-dark">{shared.privacyTitle}</h1>
        <p className="mt-4 max-w-3xl text-gray-600">{shared.privacyIntro}</p>
        <div className="mt-10 grid gap-6">
          {shared.privacySections.map((section) => (
